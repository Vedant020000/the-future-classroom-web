...
import styles from './page.module.css'; // Uses its own CSS
...
const toolData = allTools.find(tool => tool.id === 'assessment-creator');
...
const AssessmentCreatorPage = () => {
    ...
    const handleSubmit = useCallback(async (formData: Record<string, any>) => {
        ...
        setIsLoading(true);
        setResponse(null);
        console.log('Submitting Assessment Creator Request:', formData);

        try {
            const apiResponse = await fetch('/api/assessment-creator', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <AiToolForm
                ...
                isLoading={isLoading}
                submitButtonText="Generate Assessment"
            />
...
export default AssessmentCreatorPage; 