...
const toolData = allTools.find(tool => tool.id === 'differentiation-assistant');
...
const DifferentiationAssistantPage = () => {
    ...
    const handleSubmit = useCallback(async (formData: Record<string, any>) => {
        ...
        setIsLoading(true);
        setResponse(null);
        console.log('Submitting Differentiation Assistant Request:', formData);

        try {
            const apiResponse = await fetch('/api/differentiation-assistant', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <AiToolForm
                ...
                isLoading={isLoading}
                submitButtonText="Get Suggestions"
            />
...
export default DifferentiationAssistantPage; 