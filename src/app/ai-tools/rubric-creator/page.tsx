...
const toolData = allTools.find(tool => tool.id === 'rubric-creator');
...
const RubricCreatorPage = () => {
    ...
    const handleSubmit = useCallback(async (formData: Record<string, any>) => {
        ...
        setIsLoading(true);
        setResponse(null);
        console.log('Submitting Rubric Creator Request:', formData);

        try {
            const apiResponse = await fetch('/api/rubric-creator', {
                method: 'POST',
                headers: {
    ...
    return (
        <div className={styles.pageContainer}>
            ...
            <AiToolForm
                ...
                isLoading={isLoading}
                submitButtonText="Create Rubric"
            />
...
export default RubricCreatorPage; 